...
@endif            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
...
@endif
           ...
           <td>
           <button 
                type="button" class="btn btn-Danger" href="route{ }"><i class="fa-solid fa-pencil fa-lg"></i> Edit
            </button>
          
            <button 
                type="button" class="btn btn-Danger" href="route{ }"><i class="fa-solid fa-trash fa-lg"></i> delete
            </button>
        </td>
          </tr>
          @endforeach
